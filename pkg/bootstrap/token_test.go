...
func TestGenerateTokenSecret(t *testing.T) {
	...
	}{{name: "testing valid token name", secret: "50ydlk.7up8oiki8zp3qoyh", wantSecret: &v1.Secret{ObjectMeta: metav1.ObjectMeta{Name: "bootstrap-token-50ydlk"}}, wantErr: func(err error) (string, bool) {
		return "err == nil", err == nil
	}}, {name: "testing invalid token name", secret: "fooo", wantSecret: nil, wantErr: func(err error) (string, bool) {
		return "err != nil", err != nil
	}}}
